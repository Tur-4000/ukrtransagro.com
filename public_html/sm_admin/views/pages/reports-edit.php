...
<div class="work editWindow">
    <form action="" enctype="multipart/form-data" method="post">
        ...
        <div id="lang_ru" class="language">
            ...
            <input type="text" name='report_name_ru' value="<?=$data['report_name_ru']?>" placeholder=""><pre></pre>
        </div>
        <div id="lang_ua" class="language">
            <label>Название документа UA</label>
            <input type="text" name='report_name_ua' value="<?=$data['report_name_ua']?>" placeholder=""><pre></pre>
        </div>
